...
namespace embDB
{
	template<typename _TKey,
		...
		class BPTreeLeafNodeSetBase : public  BPBaseTreeNode
	{
	public:
		...
		BPTreeLeafNodeSetBase(CommonLib::alloc_t *pAlloc, bool bMulti, uint32 nPageSize) :
		...
		bool UnionWith(BPTreeLeafNodeSetBase* pNode, bool bLeft,
			int *nCheckIndex = 0)
		{
	...
	template<typename _TKey,
		class _Transaction, class _TCompressor>
		class BPTreeLeafNodeSet : public  BPTreeLeafNodeSetBase <_TKey, _Transaction, _TCompressor>
	{
	public:
		...
		BPTreeLeafNodeSet(CommonLib::alloc_t *pAlloc, bool bMulti, uint32 nPageSize) :
		...
		bool IsUnion(BPTreeLeafNodeSet *pNode)		{

			return this->m_Compressor.IsUnion(pNode->m_Compressor);
		}
		bool IsAlignment(BPTreeLeafNodeSet *pNode)
		{
