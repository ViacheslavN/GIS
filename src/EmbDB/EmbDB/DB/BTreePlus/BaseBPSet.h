...
namespace embDB
{
	...
	public: 
		...
		TBPlusTreeSetBase(int64 nPageBTreeInfo, _Transaction* pTransaction, CommonLib::alloc_t* pAlloc, uint32 nChacheSize, uint32 nNodesPageSize, bool bMulti = false, bool bCheckCRC32 = true) :
		...
		TBTreeNodePtr CreateNode(int64 nAddr, bool bIsLeaf)
		{
			...
			return TBTreeNodePtr(new TBTreeNode(-1, m_pAlloc, nAddr, m_bMulti, bIsLeaf, m_bCheckCRC32, m_nNodesPageSize, m_InnerCompParams.get(),
				m_LeafCompParams.get()), std::bind(&TBPlusTreeSetBase::deleteNodePtr, this, std::placeholders::_1));
...
#define  BPSETBASE_DECLARATION  TBPlusTreeSetBase<_TKey, _TComp, _Transaction, _TInnerCompess, _TLeafCompess, _TInnerNode, _TLeafNode, _TBTreeNode>

#include "BaseBPSetInsert.h"
#include "BaseBPSetSearch.h"
#include "BaseBPSetDelete.h"
}