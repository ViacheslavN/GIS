#ifndef _EMBEDDED_DATABASE_FIXED_STRING_BWT_COMPRESSOR_H_
#define _EMBEDDED_DATABASE_FIXED_STRING_BWT_COMPRESSOR_H_
#include <map>
#include <vector>
...
namespace embDB
{
	...
	public:
		...
		TFixedStringZlibCompressor(CommonLib::alloc_t *pAlloc, CompressorParamsBaseImp *pParams, uint32 nError = 200 /*0.5%*/, bool bOnlineCalcSize = false) :  m_dBitRowSize(0),
