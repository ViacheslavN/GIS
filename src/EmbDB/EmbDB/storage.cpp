...
namespace embDB
{
	...
	CFilePage* CStorage::getFilePage(int64 nAddr, bool bRead){
	...
	bool CStorage::dropFilePage(CFilePage* pPage)
	{
		if(!m_bCommitState)
			return false;
	...
	CFilePage* CStorage::getNewPage(bool bWrite)
	{
	...
	{
		CFilePage* pPage = getFilePage(m_nStorageInfo);
		if(!pPage)
			return false;
