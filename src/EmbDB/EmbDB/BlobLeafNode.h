...
namespace embDB
{
	...
	class TBlobLeafNode : public  BPTreeLeafNodeMapv2<_TKey, sStringVal, _Transaction, BPFixedStringLeafNodeCompressor<_TKey> >
	{
	public:
		typedef   BPTreeLeafNodeMapv2<_TKey, sStringVal, _Transaction, BPFixedStringLeafNodeCompressor<_TKey> > TBase;
