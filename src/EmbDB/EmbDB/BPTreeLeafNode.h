#ifndef _EMBEDDED_DATABASE_B_PLUS_TREE_LEAF_NODE_H_
#define _EMBEDDED_DATABASE_B_PLUS_TREE_LEAF_NODE_H_
...
namespace embDB
{
	template<typename _TKey, typename _TValue, typename _TLink, typename _TComp, typename _TCompressor>
	class BPTreeLeafNode : public  BPTreeLeafNodeBase<_TKey, _TValue, _TLink, _TComp>
	{
	public:

		typedef  BPTreeLeafNodeBase<_TKey, _TValue, _TLink, _TComp> TBase;
		...
		BPTreeLeafNode( CommonLib::alloc_t *pAlloc, bool bMulti) :
