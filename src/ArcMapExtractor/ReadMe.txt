========================================================================
    ACTIVE TEMPLATE LIBRARY : ArcMapExtractor Project Overview
========================================================================

AppWizard has created this ArcMapExtractor project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

ArcMapExtractor.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

ArcMapExtractor.vcxproj.filters
...
ArcMapExtractor.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ArcMapExtractor.h)
        GUID definitions                                (ArcMapExtractor_i.c)
        A type library                                  (ArcMapExtractor.tlb)
        Marshaling code                                 (ArcMapExtractor_p.c and dlldata.c)

ArcMapExtractor.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ArcMapExtractor.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ArcMapExtractor.pch and a precompiled types file named StdAfx.obj.
...
ArcMapExtractorps.vcxproj
	...
	dlldata.c, ArcMapExtractor_i.c and ArcMapExtractor_p.c which are required
	to build the proxy/stub DLL.

ArcMapExtractorps.vcxproj.filters
