...
namespace agg
{
    ...
    public:
        ...
        void set_clip_rgn(const point_d* lpPoints, const int *lpPolyCounts, int nCount)
        {
          polyClip_.set_edges(lpPoints, lpPolyCounts, nCount);
         // pixfmt_bgra32 *rgbaRen = reinterpret_cast<pixfmt_bgra32*>(m_ren);
         // if(rgbaRen)
            m_ren->SetPolygonClipper(&polyClip_);
        }
        //--------------------------------------------------------------------
